...
sdldz80 -mjwx -i trek.ihx -b _CODE=0x4300 -b "_DATA=0x6000" crt0.rel lrscan.rel os.rel trek14.rel ent.rel plot.rel libc.rel libcbase.rel crtcall.rel divunsigned.rel mul.rel
